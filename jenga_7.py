...
def main():
    ...
    place_pose["5"]  = create_pose(0.6596,         0.00 + 1*gap, 0.2696 - off + z_shift, quat2)
    place_pose["6"]  = create_pose(0.6596,         0.07 + 2*gap, 0.2696 - off + z_shift, quat2)

    place_pose["7"]  = create_pose(0.5896,         0.00,         0.3556 - off + z_shift, quat1)
    place_pose["8"]  = create_pose(0.6596 + 1*gap, 0.00,         0.3556 - off + z_shift, quat1)
    place_pose["9"]  = create_pose(0.7296 + 2*gap, 0.00,         0.3556 - off + z_shift, quat1)

    place_pose["10"] = create_pose(0.6596,        -0.07,         0.4416 - off + z_shift, quat2)
    place_pose["11"] = create_pose(0.6596,         0.00 + 1*gap, 0.4416 - off + z_shift, quat2)
