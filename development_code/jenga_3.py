...
def main():
    ...
    pick_pose.orientation.x = quat2[0]
    pick_pose.orientation.y = quat2[1]
    pick_pose.orientation.z = quat2[2]
    pick_pose.orientation.w = quat2[3]
    ...
    # clear
    left_pnp.move_to(left_pnp.ik_request(clear_pose4))
