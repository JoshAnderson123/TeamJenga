...
def main():
    ...
    trim = 0 # Trim - how close brick can go from gazebo to real world
    ...
    place_pose["3"]  = create_pose(0.7296 - 2*trim, 0.0,            0.1836 - off, quat1)

    place_pose["4"]  = create_pose(0.6596,         -0.060,          0.2700 - off, quat2)
    place_pose["5"]  = create_pose(0.6596,          0.005 - 1*trim, 0.2700 - off, quat2)
    place_pose["6"]  = create_pose(0.6596,          0.070 - 2*trim, 0.2700 - off, quat2)

    place_pose["7"]  = create_pose(0.5896,          0.0,            0.3570 - off, quat1)
    place_pose["8"]  = create_pose(0.6596 - 1*trim, 0.0,            0.3570 - off, quat1)
    place_pose["9"]  = create_pose(0.7296 - 2*trim, 0.0,            0.3570 - off, quat1)

    place_pose["10"] = create_pose(0.6596,         -0.060,          0.4440 - off, quat2)
